...
local Fz = {
		...
		["Logo Image"] = "rbxassetid://78574550792116",
...
gz.Image = "rbxassetid://78574550792116";
...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">Cảnh Sát Cơ Động Hub</font> " .. dz.TitleNameNoti));
...
function Kz.CreateMain(Y)
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">Cảnh Sát Cơ Động Hub </font> : Blox Fruits");
	...
	F.Position = UDim2.new(0, 5, 0, dz.T1 and 5 or 0);
	F.Size = UDim2.new(0, dz.T1 and 30 or 25, 0, dz.T1 and 15 or 25);
	F.Image = "rbxassetid://78574550792116";
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">Cảnh Sát Cơ Động Hub </font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
